...
public class PageClass {
	...
	public static ExcelReader excel = new ExcelReader(
			System.getProperty("user.dir") + "\\src\\test\\resources\\com\\w2a\\excel\\test_data.xlsx");
	...
	public PageClass() {
		...
		if(driver==null) {
				...
				try {
					...
					e.printStackTrace();
					System.out.println("This is my test catch exception");
				}
				try {
					config.load(fis);
				...
				try {
					fis = new FileInputStream(
							System.getProperty("user.dir") + "\\src\\test\\resources\\com\\w2a\\properties\\ObjRepo.properties");
				} catch (FileNotFoundException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	//Common Keywords
		...
		public void select(String locator, String value) {
			...
			if (locator.endsWith("_CSS")) {
				...
				dropdown = driver.findElement(By.xpath(objrepo.getProperty(locator)));
			} else if (locator.endsWith("_ID")) {
				dropdown = driver.findElement(By.id(objrepo.getProperty(locator)));
			}
